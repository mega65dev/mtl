...
export("basic.rom","../emulator/include/basic_rom.inc",0)
export("character.rom","../emulator/include/character_rom.inc",1)
#export("monitor.rom","../emulator/monitor_rom.inc")
export("cegmon.rom","../emulator/include/monitor_rom.inc",0)
#
#	Comment this out to run cegmon instead.
#
#export("../monitor/monitor.rom","../emulator/monitor_rom.inc",0)